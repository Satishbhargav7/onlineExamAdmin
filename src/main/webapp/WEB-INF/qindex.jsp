...
<body>
	<div class="container">
		...
		<div class="adminBlock">
			<div class="row">
				<div class="col-md-6">
					<label class="control-label">Click to Add Question:</label> <label
						class="control-label">Click to Upload Question Paper:</label> <!-- <label
						class="control-label">Click to Download Candidate Data:</label>
						 <label	class="control-label">Click Candidate Results Report:</label> -->
				</div>
				<div class="col-md-6">
					<div class="mgn-left">
						<a href="createQuestion" class="btn btn-primary">Add Question </a>
					</div>
					<div class="mgn-left">
						<a href="uploadQuestion" class="btn btn-primary">Upload Question Paper </a>
					</div>
					<!-- <div class="mgn-left">
