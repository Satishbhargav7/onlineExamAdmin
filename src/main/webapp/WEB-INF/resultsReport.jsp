...
<body>
	<div class="container">
		...
		<form class="form-horizontal" id="ecportCandidate" action="pdf" method="post">
			...
			<div class="col-md-12">
				<div class="preBtn text-center">
					<button type="submit" class="btn btn-primary submit" value="Generate Report">Generate Report</button>
				</div>
			</div>
		</form>
		<div class="footer">
