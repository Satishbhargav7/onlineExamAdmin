				...
				<div class="adminBlock">
					<div class="btn-group-vertical">
						<a href="posturl" class="btn btn-primary">Post</a> <a
							...
							href="locationNameWithSession" class="btn btn-primary">Exam Location With Session</a>
						<a href="cindexurl" class="btn btn-primary">Candidate</a> <a
							href="addQuestionUrl" class="btn btn-primary">Question</a>
