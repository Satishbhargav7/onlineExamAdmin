...
<body>
	<div class="container">
		...
		<form class="form-horizontal" id="ecportCandidate" action="downloadCandidate" method="post">
			...
			<div class="col-md-12">
				<div class="preBtn text-center">
					<button type="submit" class="btn btn-primary submit" value="Download">Download</button>
				</div>
			</div>
		</form>
		<div class="footer">
